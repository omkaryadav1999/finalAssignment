...
function Personal() {
    ...
    const getMiddlename = (e) => {
        ...
        Number(name)
        if (isNaN(name)) {
            setMiddleName(name.toLowerCase())
        } else {
            alert("plase Enter chacter")
            setMiddleName("")
        }
        ...
        if (validation()) {
            if (edit) {
                ...
                if (check.length === 0) {
                    ...
                    alert("mobile number is alredy register")
        ...
        <div className="main_container">
            <div className="from_container">
                ...
                <form onSubmit={submitData}>
                    ...
                    <input type="text" value={name} required autoComplete="off" name="name" onChange={getName} />&nbsp;&nbsp;<br /><br />

                    <label htmlFor="MiddleName" >MiddleName:</label>&nbsp;&nbsp;

                    <input type="text" value={middlename} required autoComplete="off" name="middleName" onChange={getMiddlename} />&nbsp;&nbsp;<br /><br />

                    <label htmlFor="Lastname" >Lastname:</label>&nbsp;&nbsp;

                    <input type="text" value={lastname} required autoComplete="off" name="lastname" onChange={getLastname} />&nbsp;&nbsp;<br /><br />
